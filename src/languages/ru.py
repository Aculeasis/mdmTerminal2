class _ConfigPrettyModels:
    ...
    def format(cls, count):
        ...
        return 'Загр+ужен{} {} модел{}'.format(ot, count, et)
...
CONFIG = {
    ...
    'load_for': 'Загр+ужено {} опций за {}',
    'lng_load_for': 'Локализация {} загр+ужена за {}',
...
TERMINAL = {
    ...
    'rec_hello': 'Запись {} образца начнется после звукового сигнала',
